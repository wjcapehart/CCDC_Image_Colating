PRO LE07_individual_to_bip 
  ...
  inventory_file = "/fdrive/Projects/ccdc/CCDC_Image_Colating/inventory_"+path_row+"_LE07.txt"

  blank_hdr_file  = "/fdrive/Projects/ccdc/CCDC_Image_Colating/"+path_row+"_landsat7_8band.hdr"
